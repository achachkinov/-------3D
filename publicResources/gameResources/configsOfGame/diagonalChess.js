...
headOfKnigth.rotateAroundAxisY( -45 )
...
function pawnPossibleEat( board, startPos, itteratorNum , endPos ) {
    ...
    if ( isEnableCellOnPos & isEnableFigurOnPos  ) {
        ...
        return result
    } else if ( isEnableCellOnPos & !isEnableFigurOnPos ) {
        return true
    }
}
...
function pawnChangeBoard( board, startPos, endPos ) {
    ...
    if ( !board.isEnableCellOnPos( testPos1 )  ) {
...
let initializationListWhiteFigurs = [
    ...
    [ "knight3", whiteKnightType],
    [ "knight4", whiteKnightType],
    [ "rock1", rockType],
    [ "rock2", rockType],
    [ "queen1", queenType ],
    [ "queen2", queenType ],
...
let initializationListBlackFigurs = [
    ...
    [ "knight3", blackKnightType],
    [ "knight4", blackKnightType],
    [ "rock1", rockType],
    [ "rock2", rockType],
    [ "queen1", queenType ],
    [ "queen2", queenType ],
...
let lite = new Lite()
lite.setDirection( new Dot( 1,-1,0 ) )
lite.setReflexPower( 40 )
...
function arrangeWhiteFigur( board ) {
    ...
    board.setPositionForSelectFigur( new Pos( 0, 3 ) )
    board.selectFigurByName( "whiterock2" )
    board.setPositionForSelectFigur( new Pos( 0, 2 ) )
    board.selectFigurByName( "whiteknight3" )
    board.setPositionForSelectFigur( new Pos( 2, 1 ) )
    board.selectFigurByName( "whiteknight4" )
    board.setPositionForSelectFigur( new Pos( 1, 2 ) )
    ...
    board.setPositionForSelectFigur( new Pos( 2, 2 ) )
    board.selectFigurByName( "whitepawn4" )
    board.setPositionForSelectFigur( new Pos( 1, 3 ) )
...
function arrangeBlackFigur( board ) {
    ...
    board.setPositionForSelectFigur( new Pos( 7, 4 ) )
    board.selectFigurByName( "blackknight3" )
    board.setPositionForSelectFigur( new Pos( 5, 6 ) )
    board.selectFigurByName( "blackknight4" )
    board.setPositionForSelectFigur( new Pos( 6, 5 ) )
    board.selectFigurByName( "blackrock2" )
    board.setPositionForSelectFigur( new Pos( 7, 5 ) )
    ...
    board.setPositionForSelectFigur( new Pos( 5, 5 ) )
    board.selectFigurByName( "blackpawn4" )
    board.setPositionForSelectFigur( new Pos( 6, 4 ) )
